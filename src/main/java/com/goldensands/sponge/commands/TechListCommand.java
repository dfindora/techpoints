...
@NonnullByDefault
public class TechListCommand implements CommandExecutor
{
    private final Techpoints plugin;

    public TechListCommand(Techpoints plugin)
    {
        this.plugin = plugin;
    }
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException
    {
        ...
        {
            if(src.hasPermission("techpoints.techlist"))
            {
                ...
                techpointsModule.techPointsMessages(techChunk, (Player) src, true);
            }
            else
            {
